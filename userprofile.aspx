                    ...
                    <div class="card-body">
                        ...
                        <div class="col">
                            <center>
                                ...
                                <asp:Label class="badge-pill bg-success" ID="status" Text="your status" runat="server" />
                            </center>
                        </div>
                        <div class="row">
                            <div class="col">
                         ...
                         <div class="row">
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="opassword" runat="server" placeholder="currentPassword" TextMode="password" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                               <div class="col-md-4">
                                <label>New Password</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="newpass" runat="server" placeholder="newpassword" TextMode="password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-md-7 mx-auto">
                                  <center>
                                <div class="form-group">
                                    <asp:Button class="btn btn-success btn-block btn-lg" ID="update" runat="server" text="Update" OnClick="update_Click"></asp:Button>
                                </div></center>
                            </div>
            ...
            <div class="col-md-7">
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col"> 
                                <center><img width="90" src="imgs/books1.png" /> 
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        <div class="col">
                            <center>
                                ...
                                <asp:Label class="badge-pill bg-info" id="Label2" Text="info about Books Due date" runat="server" />
                            </center>
                        </div>
                    </div>
                     <div class="row">
